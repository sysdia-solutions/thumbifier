defmodule ProcessorTest do
  ...
  test "process - success for psd file format", %{data: data, remote_fixtures_path: remote_fixtures_path} do
    data = Map.merge(data, %{"media_url" => remote_fixtures_path <> "psd.psd"})
